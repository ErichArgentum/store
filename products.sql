...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `ProductType` varchar(100) COLLATE latin1_german2_ci NOT NULL,
...
INSERT INTO `products` (`ProductID`, `ProductSKU`, `ProductName`, `ProductPrice`, `ProductSize`, `ProductCartDesc`, `ProductShortDesc`, `ProductLongDesc`, `ProductType`, `ProductImage`, `ProductCategoryID`, `ProductUpdateDate`, `ProductStock`, `ProductLive`, `ProductUnlimited`, `ProductLocation`) VALUES
